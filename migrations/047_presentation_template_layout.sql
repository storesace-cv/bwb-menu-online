-- Layout editável por template: coluna layout_definition; payload público inclui presentation_layout_definition.

ALTER TABLE public.menu_presentation_templates
  ADD COLUMN IF NOT EXISTS layout_definition jsonb DEFAULT NULL;

-- public_menu_by_hostname: incluir presentation_layout_definition em secções e categorias
