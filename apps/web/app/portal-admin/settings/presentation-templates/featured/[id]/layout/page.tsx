...
import { LayoutEditorClient } from "../../../[id]/layout/layout-editor-client";
import { updateFeaturedPresentationTemplateLayout } from "@/app/portal-admin/actions";
...
export default async function FeaturedTemplateLayoutPage({ params }: Props) {
  ...
  return (
    <div>
      ...
      <p className="text-slate-400 mb-6">
        Ajuste a altura do card e a ordem dos campos do modelo de destaques. No menu público, o card usa imagem de fundo e overlay.
      </p>
      <Card>
        <LayoutEditorClient
